...
import EnhancedConfigurationPanel, { ConfigurationOption } from '../../shared/components/ui/EnhancedConfigurationPanel';
...
import { loadSetting, saveSetting } from '../../shared/services/SettingsService';
...
const Settings: React.FC = () => {
  ...
  ], [showHelpPage, showImport, showDirectImport, showRuleEngine, showUnifiedDashboard, showLegacyDashboard, enableAdvancedFeatures, enableDebugMode]);
    ...
    <div className="p-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow border border-gray-200 mb-6">
        ...
        <p className="text-sm text-gray-600 mb-4">
          These pages are hidden from the main navigation but can be accessed directly:
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {(() => {
            ...
            const enabledDebugItems = navigationController.getEnabledDebugNavigationItems();
        ...
        {(() => {
          ...
          return allItems.length === 0 && (
            <div className="text-center py-8 text-gray-500">
              <p>No advanced pages available for your current experience level.</p>
              <p className="text-sm mt-1">Switch to a higher level to access more features.</p>
            </div>
          );
        })()}
      </div>
