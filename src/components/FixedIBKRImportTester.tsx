...
import { mapToDatabaseTrade } from '../services/TradeMapper';
import { toast } from 'react-toastify';
import { BrokerType, AssetCategory, OpenCloseIndicator } from '../types/trade';
    ...
    try {
      ...
      if (importResult.success && Array.isArray(importResult.trades) && importResult.trades.length > 0) {
        ...
        const normalizedTrades = importResult.trades.map((t: any) => ({
          ...
          fees: t.fees || null,
          netAmount: t.netAmount || (t.proceeds - (t.basis ?? 0) - (t.commissionFee ?? 0)),
        ...
        await insertSummary(importResult.cumulativePL ?? 0);
