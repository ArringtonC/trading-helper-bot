...
interface Utils {
  getOptimalViewMode: (userLevel: UserLevel, isMobile: boolean) => ViewMode;
  calculateGoalAlignment: (stock: any, userGoals: any[]) => GoalAlignmentResult;
...
export const UTILS: Utils = {
  ...
  formatters: {
    ...
    percentage: (value: number): string => new Intl.NumberFormat('en-US', {
      style: 'percent',
