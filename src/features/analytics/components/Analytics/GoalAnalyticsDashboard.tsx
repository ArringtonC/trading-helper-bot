...
import { GoalSizingConfig } from '../../../goal-setting/types/goalSizing';
  ...
  useEffect(() => {
    const loadAnalyticsData = async () => {
      ...
      try {
        ...
        const analyticsDataService = new (await import('../../../../shared/services/AnalyticsDataService')).AnalyticsDataService();
