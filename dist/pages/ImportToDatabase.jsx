...
import ImportToDatabaseTester from '../components/FixedIBKRImportTester';
...
export default function ImportToDatabase() {
    ...
    return (<div className="container mx-auto px-4 py-8">
      <div className="flex items-center mb-6">
        <button type="button" onClick={handleBack} className="mr-4 text-gray-500 hover:text-gray-700">
      ...
      <ImportToDatabaseTester navigate={navigate}/>
    </div>);
}
