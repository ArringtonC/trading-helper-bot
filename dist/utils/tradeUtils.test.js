...
describe('P&L Calculations', function () {
    describe('getPLFromTrade', function () {
        it('should return realized PL for closed trades', function () {
            var closedTrade = {
                id: 'T123',
                status: 'closed',
                realizedPL: 125.23
        ...
        it('should return unrealized PL for open trades', function () {
            var openTrade = {
                id: 'T456',
                status: 'open',
                unrealizedPL: -37.80
        ...
        it('should return 0 for trades with missing PL values', function () {
            var tradeWithoutPL = {
                id: 'T789',
                status: 'closed'
            };
    ...
    describe('getPLFromCsv', function () {
        it('should calculate PL correctly from CSV data', function () {
            var csvRow = {
                proceeds: 500,
                basis: 480,
                commissionFee: 2.50
        ...
        it('should handle negative PL correctly', function () {
            var csvRow = {
                proceeds: 450,
                basis: 500,
                commissionFee: 2.50
    ...
    describe('calculateTradePL', function () {
        it('should calculate PL for closed trades', function () {
            var closedTrade = {
                id: 'T123',
                symbol: 'AAPL',
                quantity: 1,
        ...
        it('should calculate PL for open trades', function () {
            var openTrade = {
                id: 'T456',
                symbol: 'AAPL',
                quantity: 1,
        ...
        it('should handle trades with missing PL values', function () {
            var tradeWithoutPL = {
                id: 'T789',
                symbol: 'AAPL',
                quantity: 1,
    ...
    describe('IBKR Trade P&L Calculations', function () {
    ...
    describe('CSV Cumulative P&L', function () {
        it('should calculate cumulative P&L correctly from trades', function () {
            var trades = [
                {
                    id: '1',
                    symbol: 'AAPL',
            ...
            var result = calculateCumulativePL(trades);
            // Verify trade count
